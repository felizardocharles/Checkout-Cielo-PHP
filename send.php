...
// Não testei o uso da recorrência de pagamento
//$recorrencia[] =array(
//    'Interval' => 'Monthly',
//    'EndDate' => 'YYYY-MM-DD'
//);
...
$dados = array(
    ...
    'Options'=>array(
        'AntifraudEnabled' => FALSE, // Não testei o uso da Anti-Fraude
...
if (json_last_error()) {
    ...
    // Considerar somente o primeiro índice (só haverá mais de um em caso de erro).
    if(is_array($response)){
        $response = $response[0];
    }

    if (isset($response->Message)) {
        echo 'Erro ao conectar com a Cielo: '.$response->Message;
    } else {
        ...
        if (!empty($checkoutUrl)) {
            ...
            echo 'Erro ao gerar link de carrinho da Cielo!';
        }
    }
}
